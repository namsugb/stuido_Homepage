...
export default function ProductsPageContent() {
    ...
    const products: Array<{
        ...
        popular?: boolean;
            ...
            },
            {
                ...
                duration: "문의",
                people: "2명",
                image: "/product/product_24_v2.jpg",
            ...
            },
            {
                ...
                duration: "문의",
                people: "가족 전체",
                image: "/product/product_23_v2.jpg",
                features: ["28×36cm 기본액자 1개"],
            ...
            },
            {
                ...
                duration: "문의",
                people: "1명",
                image: "/product/product_21_v2.jpg",
            ...
            },
            {
                ...
                duration: "문의",
                people: "1명",
                image: "/product/product_17_v2.jpg",
            ...
            },
            {
                ...
                duration: "문의",
                people: "문의",
                image: "/product/product_28_v2.jpg",
                features: ["사진 복원 서비스"],
            ...
            },
            {
                ...
                duration: "문의",
                people: "문의",
                image: "/product/product_19_v2.jpg",
                features: ["주니어 사진 촬영"],
    ...
    return (
        <div className="min-h-screen">
            <main className="container mx-auto px-3 page-content pb-20">
                ...
                {activeTab === "individual" && (
                    <div className="mb-16 bg-card rounded-lg shadow-sm">
                        <h2 className="text-2xl font-medium mb-6 text-center">개별 상품</h2>
                                    ...
                                    <div key={product.id} className="bg-card shadow-md overflow-hidden relative group flex flex-col">
                                        ...
                                        <div className="p-2 bg-card">
                                            <div className="text-center">
                                                ...
                                                <div className="text-xs md:text-sm font-bold text-[#bfa888] mb-1">{product.price}</div>
                                        ...
                                        <div key={product.id} className="bg-card shadow-md overflow-hidden relative group flex flex-col">
                                            ...
                                            <div className="p-2 bg-card">
                                                <div className="text-center">
                                                    ...
                                                    <div className="text-sm font-bold text-[#bfa888] mb-1">{product.price}</div>
                                                    <div className="text-xs text-gray-600">
                                                        {product.features && product.features.length > 0 && product.features.join(", ")}
                                                    </div>
                                                </div>
                                ...
                                <div key={product.id} className="bg-white shadow-lg overflow-hidden relative group flex flex-col">
                                    ...
                                    <div className="p-3 bg-white">
                                        <div className="text-center">
                                            ...
                                            <div className="text-sm md:text-lg font-bold text-[#bfa888]">{product.price}</div>
                                        </div>
                                    </div>
                                </div>
                            ))}
