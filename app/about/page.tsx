            ...
            <main className="container mx-auto px-4 pt-24 pb-20">
                ...
                <section className="mb-16 flex flex-col md:flex-row items-start gap-8 md:gap-16">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-gray-700 mb-2">
                            ☀️ "사진, 잘 나온 것도 좋지만… 오래 남는 게 더 좋더라고요."<br />
                            안녕하세요 :)<br />
                            저희는 순천에 있는 아침햇살스튜디오입니다.<br />
                            요즘은 워낙 사진 잘 찍는 분들도 많고,<br />
                            폰 카메라도 참 잘 나와요.<br />
                            그래도 누군가 "진짜 나다운 사진을 남기고 싶다"고 하실 땐<br />
                            늘 마음이 움직여요.<br />
                            ...
                            인물사진, 그 이상의 사진<br />
                            저희가 제일 많이 찍는 건<br />
                            취업사진, 중년 인생사진, 영정사진, 가족프로필사진이에요.<br />
                            그중에서도 부모님 인물사진은 늘 특별하게 느껴져요.<br />
                            나중에 영정사진이 되더라도<br />
                            차분하고 자연스럽고,<br />
                            그분의 인생이 고스란히 담긴 사진 한 장을 남겨드리고 싶어요.<br />
                            그래서 촬영도, 보정도, 출력도 한 컷 한 컷 신중하게 진행합니다.<br />
                            <br />
                            🌞 우리만의 사진, 우리만의 순간<br />
