...
import { Camera, Clock, Star, Users, ArrowRight, CheckCircle, Image as ImageIcon, Sparkles, Phone } from "lucide-react"
...
export default function RestorationClient() {
    ...
    const beforeAfterExamples = [
        {
            imgSrc: "/restoration/recovery1.jpg",
            title: "오래된 가족사진 복원",
            description: "50년 전 가족사진을 선명하고 아름답게 복원"
        },
        {
            imgSrc: "/restoration/recovery2.jpg",
            title: "찢어진 사진 수리",
            description: "찢어진 부분을 자연스럽게 연결하여 완전 복원"
        },
        {
            imgSrc: "/restoration/recovery3.jpg",
            title: "흑백사진 컬러 복원",
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* 헤더 섹션 */}
            <section className="relative bg-gradient-to-br from-[#f5eee6] to-[#e8e0d0] mt-34">
                <div className="container mx-auto px-6 mt-20">
                    <div className="text-center max-w-4xl mx-auto py-20 mb-20">
